(() => {
    ...
    function initSliders2() {
        new core(".journey-slider__slider", {
            modules: [ Thumb, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
            speed: 800,
            ...
            thumbs: {
                swiper: {
                    ...
                    on: {
                        click: function() {
                            document.querySelectorAll(".journey__thumbs-slide");
                            var currentThumbs = document.getElementsByClassName("swiper-slide-thumb-active");
                            currentThumbs[0].className = currentThumbs[0].className.replace(" swiper-slide-thumb-active", "");
                            this.className += " swiper-slide-thumb-active";
                            currentThumbs[0].className = currentThumbs[0].className.replace(" swiper-slide-thumb-active", "");
                        }
                    }
                }
 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (iconMenu) iconMenu.addEventListener("click", (function(e) {
                if (bodyLockStatus) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                    menuBody.classList.toggle("menu-body-open");
                    headerBody.classList.toggle("header-body-open");
                }
            }));
        }
        ...
        if (document.documentElement.clientWidth < 992) flsModules.popup = new Popup({});
        function isObject(obj) {
            return null !== obj && "object" === typeof obj && "constructor" in obj && obj.constructor === Object;
        }
        function extend(target = {}, src = {}) {
        ...
        da.init();
        const script_anchors = document.querySelectorAll("a.scroll-to");
    ...
    var elem = document.querySelector(".resources__items");
    var iso = new Isotope(elem, {
        itemSelector: ".resources__item",
        transitionDuration: "0.2s",
        masonry: {
            gutter: 40
        }
    });
    const resourcesFiltersContainer = document.querySelector(".resources__filters");
    const filters = resourcesFiltersContainer.querySelectorAll(".resources__filter");
    if (resourcesFiltersContainer) for (var i = 0; i < filters.length; i++) filters[i].addEventListener("click", (function() {
        var current = document.querySelector(".resources__filter-active");
        current.classList.remove("resources__filter-active");
        this.className += " resources__filter-active";
